...
Usage:
    python scripts/train_qmix.py                        # time-boxed default run
    python scripts/train_qmix.py --time-budget 5400     # train up to 1.5 h
    python scripts/train_qmix.py --episodes 400         # or cap by episode count
...
def main() -> None:
    ...
    print(f"QMIX training on device={device}, grid={args.grid}, max_steps={args.max_steps}, "
